(() => {
    ...
    var galleryThumbsOne = new Swiper(".gallery-thumbs-1", {
        spaceBetween: 10,
        slidesPerView: 6,
        loop: true,
        freeMode: true,
    ...
    var galleryThumbsTwo = new Swiper(".gallery-thumbs-2", {
        spaceBetween: 10,
        slidesPerView: 6,
        loop: true,
        freeMode: true,
    ...
    var galleryThumbsThry = new Swiper(".gallery-thumbs-3", {
        spaceBetween: 10,
        slidesPerView: 6,
        loop: true,
        freeMode: true,
    ...
    new Swiper(".gallery-top-3", {
        ...
        loopedSlides: 5,
        thumbs: {
            swiper: galleryThumbsThry
        }
    });
    var galleryThumbsFour = new Swiper(".gallery-thumbs-4", {
        spaceBetween: 10,
        slidesPerView: 6,
        loop: true,
        freeMode: true,
    ...
    new Swiper(".gallery-top-4", {
        spaceBetween: 30,
        loop: true,
        loopedSlides: 5,
        thumbs: {
            swiper: galleryThumbsFour
        }
    });
    window["FLS"] = true;
    isWebp();
